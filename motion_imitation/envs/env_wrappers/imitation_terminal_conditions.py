...
def imitation_terminal_condition(env,
  ...
  foot_links = [16, 17, 18, 20, 21, 22, 23, 24, 25, 29, 30, 31, 33, 34, 35, 36, 37, 38]  # env.robot.GetFootLinkIDs()
  ...
  if env.env_step_counter > 0:
    robot_ground_contacts = env.pybullet_client.getContactPoints(
        bodyA=env.robot.biped, bodyB=ground)
  ...
  root_pos_fail = (
      root_pos_diff.dot(root_pos_diff) >  # distance between sim root and ref root
